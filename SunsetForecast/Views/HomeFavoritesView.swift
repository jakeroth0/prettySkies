// SunsetForecast/Views/HomeFavoritesView.swift
                    ...
                    VStack(spacing: 16) {
                        ...
                        ZStack(alignment: .top) {
                            ...
                            List {
                                // — My Location Card —
                                Button {
                                    print("[HomeFavoritesView] Tapped on Current Location")
                                ...
                                ForEach(favoritesStore.favorites) { loc in
                                    Button {
                                        print("[HomeFavoritesView] Tapped on favorite: \(loc.displayName)")
                                            ...
                                            SearchResultRow(location: location) {
                                                Task {
                                                    do {
                                                        ...
                                                        print("[HomeFavoritesView] Selected search result: \(loc.displayName)")
                                                        ...
                                                        print("[HomeFavoritesView] Error loading search result details: \(error)")
                                                    }
                                                }
                                            }
